...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="parallelfoxa_metadata.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<indexFile>PARALLELFOXA_METADATA.CDX</indexFile>
