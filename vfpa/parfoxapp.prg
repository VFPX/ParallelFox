...
STRTOFILE(PROGRAM(), "C:\VFPX\ParallelFox\mt.log", 1)	
...
PROCEDURE GetObjectName(loObject)
TEXT TO lcScript NoShow
 	LPARAMETERS loObject
 	Try
		STRTOFILE(PROGRAM() + " " + loObject.Name, "C:\VFPX\ParallelFox\mt.log")	
	EndTry
ENDTEXT
	EXECSCRIPT(lcScript , loObject)
	RETURN loObject.Name
ENDPROC 
